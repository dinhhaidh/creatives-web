...
sr.reveal(`.home__container ,  .pages__angency, features__content, .visit__data`)
...
sr.reveal(`pages__card:nth-child(1) img`, {rotate: {z: -30}, distance: 0})
sr.reveal(`pages__card:nth-child(2) img`, {rotate: {z: 15}, distance: 0, delay: 600})
sr.reveal(`pages__card:nth-child(3) img`, {rotate: {z: 30}, distance: 0, delay: 900})
